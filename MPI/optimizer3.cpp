...
int main(int argc, char *argv[]) {
    ...
    char *primes;           // 小循环用的数组
    LL primes_size;         // 质数数组大小，小循环中的
    LL chunk;               /* chunk size for *marked to adapt cache size */
...
// ============================================================== 小循环预处理primes
    ...
    primes_size = ODD_TO_INDEX(sqrt(n)) + 1;      // 用于筛的数中 奇数的总数
    primes = (char *) calloc(primes_size,1);     //存prime
